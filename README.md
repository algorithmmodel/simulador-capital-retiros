...
La diferencia entre el primero y los otros dos es el punto del proyecto. Con la configuración por defecto, exigiendo 90% de éxito el histórico permite retirar un 43% menos que el modelo de CAGR fijo. Esa diferencia es el costo de planificar contra la peor secuencia posible en vez de contra el promedio.
